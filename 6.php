...
<body>
        ...
        <main>
            <div class="container">
                <div class="work">
                    <h2>Дом в Златоусте 1440м²</h2>
                        <img src="img/6/1.jpg" class="pictures" alt="">
                        <img src="img/6/3.png" class="pictures" alt="">
                        <img src="img/6/4.png" class="pictures" alt="">
                        <img src="img/6/5.jpg" class="pictures" alt="">
