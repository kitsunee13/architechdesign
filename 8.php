...
<body>
        ...
        <main>
            <div class="container">
                <div class="work">
                    <h2>Супермаркет FRESH</h2>
                        <img src="img/8/1.jpg" class="pictures" alt="">
                        <img src="img/8/2.jpg" class="pictures" alt="">
                        <img src="img/8/3.png" class="pictures" alt="">
                        <img src="img/8/4.jpg" class="pictures" alt="">
                        <img src="img/8/5.jpg" class="pictures" alt="">
                    </div>
                </div>
            </div>
        </main>
