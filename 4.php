...
<body>
        ...
        <main>
            <div class="container">
                <div class="work">
                    <h2>Региональная Ипархия</h2>
                        <img src="img/4/1.png" class="pictures" alt="">
                        <img src="img/4/2.png" class="pictures" alt="">
                        <img src="img/4/3.png" class="pictures" alt="">
                        <img src="img/4/4.png" class="pictures" alt="">
                        <img src="img/4/5.jpg" class="pictures" alt="">
                        <img src="img/4/6.jpg" class="pictures" alt="">  
                    </div>
                </div>
            </div>
        </main>
