...
<body>
        ...
        <main>
            <div class="container">
                <div class="work">
                    <h2>Конференц-зал ГРАНИ ТАГАНАЯ</h2>
                    <h3>(Экспресс проект)</h3>
                        <img src="img/12/1.jpg" class="pictures" alt="">
                        <img src="img/12/2.jpg" class="pictures" alt="">
                        <img src="img/12/3.jpg" class="pictures" alt="">
                    </div>
                </div>
            </div>
        </main>
