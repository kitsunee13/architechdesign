...
<body>
        ...
        <main>
            <div class="container">
                <div class="work">
                    <h2>ЖК Манхэттен, 65м²</h2>
                        <img src="img/1/1.jpg" class="pictures" alt="">
                        <img src="img/1/4.jpg" class="pictures" alt="">
                        <img src="img/1/5.jpg" class="pictures" alt="">
                        <img src="img/1/6.jpg" class="pictures" alt="">
                        <img src="img/1/7.jpg" class="pictures" alt="">
                        <img src="img/1/8.jpg" class="pictures" alt="">
                        <img src="img/1/9.jpg" class="pictures" alt="">
                        <img src="img/1/2.jpg" class="pictures" alt="">
                        <img src="img/1/3.jpg" class="pictures" alt="">
